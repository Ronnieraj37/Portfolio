...
const Project = ({ title, description, gitlink, vercel, imglink }) => {
    return (
        <div className='hover:scale-105 hover:bg-[#093247] hover:border-y-[1px] hover:border-lime-200  flex-col text-white sm:ml-8 my-6 items-center justify-around bg-[#0d405c] ml-12 rounded-2xl w-[330px]  h-[270px] sm:w-[350px] sm:h-[390px] flex'>
