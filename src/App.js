  ...
  return (
    <div className="items-center flex flex-col">
      <div className="flex-col flex min-w-full items-center justify-around  overflow-auto -mt-8  font-link text-white">
        <div className="flex flex-row mt-20 ml-44">
          <div className="-ml-32 mr-8 ">
            <img onLoad={imageloaded} src="https://orange-confused-boar-516.mypinata.cloud/ipfs/QmdcE4xXBkCknQFuKftn5BoHgSp1xHRECGXUp8W5HPR7A3?_gl=1*1g0xk7f*_ga*MTY2OTI0NDAzNS4xNjgzNjU2ODM2*_ga_5RMPXG14TE*MTY5MTEyNzg5OC41LjEuMTY5MTEyNzkxOC40MC4wLjA." className="w-[230px] h-[230px] z-0 rounded-full" loading="lazy" alt="Profile" />
            {loadImage &&
          ...
          <div className="flex-col mt-9 mr-16">
            <p className="text-5xl p-2  text-cyan-300">Roshan Raj Singh</p>
            <div className="flex-row flex mt-3 w-[414px]">
              <p className="text-3xl  -mr-1 text-cyan-600">{text}</p>
              <div className="animate-pulse">
                <div class=" inline-block h-[34px] min-h-[1em] ml-2 w-0.5 self-stretch bg-cyan-600 opacity-20 dark:opacity-100"></div>
              </div>
            </div>
          </div>
          <div class="inline-block h-[250px] min-h-[1em] -mt-0 w-0.5 self-stretch bg-neutral-100 opacity-100 dark:opacity-50"></div>
          <div className="flex flex-col w-[400px] justify-around p-8 ml-8">
            <p className="text-cyan-400 text-3xl font-semibold justify-center flex mb-4 -mt-4">Contact Links</p>
            ...
            <div className="flex  justify-around flex-row">
              <a href={mailLink}>
                <button className=" mt-9 px-5 py-2 text-white rounded-3xl text-xl bg-cyan-700 hover:bg-cyan-900">Email</button>
              </a>
              <a href={resumeLink} rel="noopener noreferrer" target="_blank">
                <button className=" mt-9 text-cyan-400 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-xl px-5 py-2  dark:bg-gray-800 dark:text-cyan-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Resume</button>
              </a>
      ...
      <p className="text-cyan-400 text-3xl font-semibold justify-center flex mt-12 -ml-4">Projects</p>
      ...
      <hr class="my-6 h-0.5 border-t-0 w-[900px] bg-neutral-100 opacity-100 dark:opacity-50" />
      <p className="text-cyan-400 text-3xl font-semibold justify-center flex mt-4 -ml-4">Experience</p>
      ...
      <hr class="my-4 h-0.5 border-t-0 w-[900px] bg-neutral-100 opacity-100 dark:opacity-50" />
      <p className="text-cyan-400 text-3xl font-semibold justify-center flex mt-4 -ml-4">About Me</p>
      <p className='text-center mt-2 mb-2 font-light p-2 overflow-auto text-xl text-white w-[600px]'>8919285030 | ec21b1095@iiitdm.ac.in | Chennai, Tamil Nadu </p>
    </div>
  );
}
